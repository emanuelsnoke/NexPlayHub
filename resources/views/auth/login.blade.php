<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ml-3 bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 px-4 rounded transition duration-200">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
        ...
        <div class="text-center mt-6">
            <a href="{{ route('register') }}" class="text-sm text-purple-700 hover:underline">
                {{ __('Criar uma conta?') }}
            </a>
        </div>
    </form>
